...
class Menu(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.url:  # Only generate if URL is empty
...
class MenuItem(models.Model):
    ...
    named_url = models.CharField(max_length=100, blank=True)  # Имя URL в urls.py
    url = models.CharField(max_length=255, blank=True)        # Прямой путь, если named_url нет
